...
public class Dbean implements Comparable <Dbean> {
    private String date;
    ...
    public Dbean(String date, String title, String content, String tag, String review) {
        this.date = date;
        this.title = title;
